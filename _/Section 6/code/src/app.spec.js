...
describe('Login example', () => {
  ...
  it('should allow POST requests to the "koa/register" route', done => {
    request(server)
      .post('/koa/register')
  ...
  it('should return 400 for bad POST requests to the "koa/register" route', done => {
    request(server)
      .post('/koa/register')
  ...
  it('should return 406 for trying to register an existing user with the "koa/regis' +
      'ter" route',
  done => {
    request(server)
      .post('/koa/register')
  ...
  it('should allow POST requests to the "koa/login" route', done => {
    request(server)
      .post('/koa/login')
  ...
  it('should return 401 for bad POST requests to the "koa/login" route', done => {
    request(server)
      .post('/koa/login')
  ...
  it('should prevent GET requests to the "profile" route without a token', done => {
    request(server)
      .get('/profile')
      .expect(401)
      .end(done);
  ...
  it('should allow GET requests to the "profile" route with a valid token', done => {
    request(server)
      .get('/profile')
